...
KEYCLOAK_RESPONSE=`curl -s -X POST https://bouncer.channel40.com.au/auth/realms/channel40/protocol/openid-connect/token  -H "Content-Type: application/x-www-form-urlencoded" -d 'username=user1' -d 'password=WelcomeToTheTruck121!!' -d 'grant_type=password' -d 'client_id=channel40'  -d 'client_secret=03db7042-1d46-4fce-abf7-8c0349ab5478'`
