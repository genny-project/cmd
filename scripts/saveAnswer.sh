...
echo $TOKEN
curl -X POST --header 'Content-Type: application/json' --header 'Accept: application/json' --header "Authorization: Bearer $TOKEN" -d '{  "value": "FALSE",  "attributeCode": "PRI_OWNER",  "targetCode": "PER_INFO_AT_GLENRAEPREMIUMLAMBCOM",  "sourceCode": "PER_USER1",  "expired": false,  "refused": false,  "weight": 1.0,  "inferred": false  }' 'https://qwanda-service.channel40.com.au/qwanda/answers'
